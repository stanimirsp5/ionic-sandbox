...
function createNotificationHubJob(content) {
    ...
    return {
        jobId: (0, utils_js_1.getStringOrUndefined)(content["JobId"]),
        type: (0, utils_js_1.getString)(content["Type"], "type"),
        status: (0, utils_js_1.getStringOrUndefined)(content["Status"]),
        progress: (0, utils_js_1.getFloatOrUndefined)(content["Progress"]),
        outputContainerUrl: (0, utils_js_1.getString)(content["OutputContainerUri"], "outputContainerUrl"),
        importFileUrl: (0, utils_js_1.getStringOrUndefined)(content["ImportFileUri"]),
        failure: (0, utils_js_1.getStringOrUndefined)(content["Failure"]),
