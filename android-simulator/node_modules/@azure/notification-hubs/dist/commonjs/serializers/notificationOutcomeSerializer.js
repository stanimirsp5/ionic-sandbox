...
function parseRegistrationResults(results) {
    ...
    for (const result of resultsArray) {
        registrationResults.push({
            applicationPlatform: (0, utils_js_1.getString)(result.ApplicationPlatform, "ApplicationPlatform"),
            registrationId: (0, utils_js_1.getString)(result.RegistrationId, "RegistrationId"),
            outcome: (0, utils_js_1.getString)(result.Outcome, "Outcome"),
            pnsHandle: (0, utils_js_1.getString)(result.PnsHandle, "PnsHandle"),
        });
    }
    return registrationResults;
}
